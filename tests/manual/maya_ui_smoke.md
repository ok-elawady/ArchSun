...
- Change the city and confirm latitude, longitude, and `UTC Offset` update together.
...
- Confirm the tooltips make these meanings clear to an artist:
  ...
  - The city and UTC Offset tooltips make it clear that city and map picks provide a starting offset only and that daylight saving time still needs manual verification.
...
- Drag `archsun_uninstall_drop.py` into Maya and confirm the installed files are removed.
